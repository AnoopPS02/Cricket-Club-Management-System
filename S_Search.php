...
<div class="forms">
    <form class="forms" action="S_Profile.php" method="post">

        <h4 class="headers">Search using staff ID </h4>

        <input type="search" name="playerSearch" title="Search using Staffid ID" placeholder="Search..." required><br><br>
